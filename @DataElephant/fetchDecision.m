function [r_t,rf_t,decision,z_dec] = fetchDecision(obj,z_cum,z_step,r,rf,hash,fasthash,decision_hash,stepnr,lastStepInSequence)
    ...
    [r_t,rf_t]  = obj.getIndividual(r, rf, fieldnames(r), obj.steps(stepnr).decide, idx, size(decision_hash,1)); %#ok<FNDSB>
end